...
# ------------------------------------------
if st.experimental_get_query_params()=={} or st.experimental_get_query_params()['p'][0]=='':
    st.markdown('''<meta http-equiv="refresh" content="0; URL=https://matdadi-hivaidsjabar-hivjabar-6g57cz.streamlitapp.com/?p='''+
                load_master('menu')[0]+'''" />''', unsafe_allow_html=True)
