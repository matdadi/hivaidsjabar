...
def load_menu():
    ...
    with menu_1, _lock:
        st.markdown('''<div style="text-align: center; margin-bottom: 100px;"><a target="_self"
            href=https://share.streamlit.io/matdadi/hivaidsjabar/main/hivjabar.py?p='''+load_master('menu')[0]+
            ''' style='''+selected_style[0]+'''>'''+load_master('menu')[0]+'''</a></div>
        ''', unsafe_allow_html=True)

    with menu_2, _lock:
        st.markdown('''<div style="text-align: center; margin-bottom: 100px;"><a target="_self"
            href=https://share.streamlit.io/matdadi/hivaidsjabar/main/hivjabar.py?p='''+load_master('menu')[1]+
            ''' style='''+selected_style[1]+'''>'''+load_master('menu')[1]+'''</a></div>
        ''', unsafe_allow_html=True)

    with menu_3, _lock:
        st.markdown('''<div style="text-align: center; margin-bottom: 100px;"><a target="_self"
            href=https://share.streamlit.io/matdadi/hivaidsjabar/main/hivjabar.py?p='''+load_master('menu')[2]+
